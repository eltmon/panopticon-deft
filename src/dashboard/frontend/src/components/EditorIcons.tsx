...
export type EditorIcon = ComponentType<SVGProps<SVGSVGElement>>;

const GenericEditorIcon: EditorIcon = (props) => <Code2 {...props} />;
const FileManagerIcon: EditorIcon = (props) => <FolderClosed {...props} />;

export const KiroIcon: EditorIcon = (props) => (
...
export const AquaIcon: EditorIcon = (props) => {
...
export const CLionIcon: EditorIcon = (props) => {
...
export const DataGripIcon: EditorIcon = (props) => {
...
export const DataSpellIcon: EditorIcon = (props) => {
...
export const GoLandIcon: EditorIcon = (props) => {
...
export const IntelliJIdeaIcon: EditorIcon = (props) => {
...
export const PhpStormIcon: EditorIcon = (props) => {
...
export const PyCharmIcon: EditorIcon = (props) => {
...
export const RiderIcon: EditorIcon = (props) => {
...
export const RubyMineIcon: EditorIcon = (props) => {
...
export const RustRoverIcon: EditorIcon = (props) => {
...
export const WebStormIcon: EditorIcon = (props) => {
...
} satisfies Partial<Record<EditorId, EditorIcon>>;

const EDITOR_ICONS = {
  cursor: GenericEditorIcon,
  windsurf: GenericEditorIcon,
  trae: GenericEditorIcon,
  kiro: KiroIcon,
  vscode: GenericEditorIcon,
  'vscode-insiders': GenericEditorIcon,
  vscodium: GenericEditorIcon,
  zed: GenericEditorIcon,
  antigravity: GenericEditorIcon,
  ...JetBrainsIcons,
  'file-manager': FileManagerIcon,
} satisfies Record<EditorId, EditorIcon>;

export function editorIconFor(id: EditorId): EditorIcon {
