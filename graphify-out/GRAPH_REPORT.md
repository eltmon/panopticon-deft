...
## Corpus Check
- 2014 files · ~3,587,654 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 32109 nodes · 62194 edges · 1374 communities (1311 shown, 63 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 1336 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9e4abed`
...
## Communities (1374 total, 63 thin omitted)

### Community 0 - "Agent Session Lifecycle Management"
Cohesion: 0.01
Nodes (359): monitorReviewConvoySignals(), buildHandoffPrompt(), detectHandoffMethod(), extractSpecialistName(), HandoffError, HandoffMethod, HandoffOptions, performHandoff() (+351 more)

### Community 1 - "Merge Agent Post-Merge Lifecycle"
Cohesion: 0.02
Nodes (250): isAgentIdleForNudge(), resolveAutoResumeConfigForIssue(), StuckRemediationConfig, addLog(), apiErrorRecoveryState, autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+242 more)

### Community 2 - "Command Deck Overview Tab UI"
Cohesion: 0.02
Nodes (228): switchModel(), ComposerMode, deriveComposerMode(), IssueComposer(), IssueComposerProps, PlanningState, useZoneAActions(), ZoneAActionsState (+220 more)

### Community 3 - "Deacon Patrol and Queue"
Cohesion: 0.02
Nodes (234): readCavemanVariant(), getSpecialistState(), createSpecialistHandoff(), appendToRunLog(), appendToRunLogSync(), checkLogSizeLimit(), cleanupAllLogs(), cleanupAllLogsSync() (+226 more)

### Community 4 - "VBrief Plan Builder and Viewer"
Cohesion: 0.02
Nodes (232): decodeFlywheelRunId, defaultFlywheelPrompt(), defaultFlywheelRunId(), FlywheelLifecycleOptions, FlywheelPauseResult, FlywheelResumeResult, getLocalFlywheelRunDir(), isFlywheelDevcontainerRuntime() (+224 more)

### Community 5 - "Agent Runtime Spawning"
Cohesion: 0.02
Nodes (113): MockRuntime, getProjectDirs(), getProjectDirsSync(), getSessionFiles(), parseClaudeSession(), parseClaudeSessionSync(), SessionUsage, emptyUsage() (+105 more)

### Community 6 - "Parallel Review Pipeline Dispatch"
Cohesion: 0.01
Nodes (167): addEndtoBlockProps(), annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf (+159 more)

### Community 7 - "Specialist Handoff and Planning Spawn"
Cohesion: 0.02
Nodes (139): activeAgent, cafSpy, client, menu, onNavigateToIssues, rafSpy, scrollSpy, tiles (+131 more)

### Community 8 - "Workspace Creation and Worktree"
Cohesion: 0.02
Nodes (142): ~/.panopticon/agents/ State Directory, Agent Directory Structure, HealthThresholds, checkPendingTestDispatch(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult() (+134 more)

### Community 9 - "Conversation Database and Favorites"
Cohesion: 0.02
Nodes (147): createTerminalWindow(), MockWindow, openTerminalWindow(), terminalWindows, win, buildContextMenu(), buildMenuTemplate(), buildTooltip() (+139 more)

### Community 10 - "Agent Snapshot and Event Types"
Cohesion: 0.02
Nodes (128): SwarmDispatchDialog(), SwarmDispatchDialogProps, ActionButton(), actionButtonClass(), ActionDialogFrameProps, AGENT_SCOPE_ACTION_KEYS, BeadTask, IssueActionDialogHost() (+120 more)

### Community 11 - "Cloister Service Health and Config"
Cohesion: 0.02
Nodes (136): spawnReviewCoordinatorSession(), spawnSingleReviewer(), agentStatusCommand(), AgentStatusOptions, analyzeSession(), detectStatus(), extractCost(), extractModel() (+128 more)

### Community 12 - "Inspector Panel Terminal UI"
Cohesion: 0.03
Nodes (143): cleanupSpawnAndOrphanedStashes(), detectMergedSwarmSlots(), listFeatureWorkspaces(), logNonCanonicalStashesOnStartup(), reconcileAndCheckIfMerged(), reconcileStaleMergeStatus(), announceMerge(), buildShipPreparationPrompt() (+135 more)

### Community 13 - "Event Store Domain Services"
Cohesion: 0.02
Nodes (124): ActivityView(), AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow() (+116 more)

### Community 14 - "Kanban Board Agent Status UI"
Cohesion: 0.03
Nodes (142): HookEntry, injectCavemanSettingsPromise(), injectMemoryHookSettings(), installTrustedMemoryHookScript(), memoryHookScript(), readWorkspaceSettings(), removeMemoryHooks(), upsertHook() (+134 more)

### Community 15 - "Electron Desktop App and Tray"
Cohesion: 0.03
Nodes (131): ActivitySparkline(), ActivitySparklineProps, barColor(), CATEGORY_COLORS, SparklineCategory, SparklineEvent, fmtCost(), OverviewTab (+123 more)

### Community 16 - "Health Metrics and Settings Pages"
Cohesion: 0.02
Nodes (137): archiveReviewerRound(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewFeedbackBody(), CLAUDE_ALIAS_WORK_TYPE, ConvoyModels, DEFAULT_REVIEW_AGENTS, getFilesChangedFromPR() (+129 more)

### Community 17 - "Issue Service and Data Fetching"
Cohesion: 0.02
Nodes (121): MODEL_COLORS, agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption (+113 more)

### Community 18 - "Workspace Lifecycle and Config"
Cohesion: 0.03
Nodes (115): determineCavemanVariant(), injectCavemanSettings(), autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS, execAsync, parseValidationOutput(), QualityGateResult (+107 more)

### Community 19 - "Tmux Terminal Session Management"
Cohesion: 0.03
Nodes (126): deriveDotStatus(), presenceToStatus(), onSelectSession, ALLOWED, useLiveFlash(), resolveWorkTypeKey(), useResolvedModels(), AuthMode (+118 more)

### Community 20 - "Database Schema and Review Status"
Cohesion: 0.03
Nodes (128): PROVIDER_ENV_UNSETS, { activeSessions }, agentDir, fortyMinutesAgo, runDetermineHealthStatus(), twentyMinutesAgo, result, buildClaudeUserSettings() (+120 more)

### Community 21 - "Git Activity and Runtime Metrics"
Cohesion: 0.03
Nodes (116): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), createCostCommand(), configCommand() (+108 more)

### Community 22 - "Dashboard HTTP Routes and Admin"
Cohesion: 0.03
Nodes (122): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), ListOptions, listStatesCommand(), listTeamStates(), bundledFrontendIndex (+114 more)

### Community 23 - "Dashboard Store and Command Palette"
Cohesion: 0.03
Nodes (118): after, before, blockers, result, statuses, after, row, status (+110 more)

### Community 24 - "VBrief Lifecycle IO and Transitions"
Cohesion: 0.03
Nodes (113): config, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostLimitsConfig (+105 more)

### Community 25 - "Dialog Actions and System Health UI"
Cohesion: 0.04
Nodes (117): approveCommand(), cancelCommand(), collectInFlightRows(), collectLifecycleRows(), completeCommand(), formatTransition(), getProjectPath(), pad() (+109 more)

### Community 26 - "Specialist Metadata and Grace Period"
Cohesion: 0.03
Nodes (111): LinearState, program, transitionIssueToVerifyingOnMain(), getGitHubClient(), GitHubClient, GitHubClientError, GitHubClientLive, GitHubClientOptionalLive (+103 more)

### Community 27 - "CLI Commands and Runtime Adapters"
Cohesion: 0.03
Nodes (113): extractAcceptanceCriteria(), getUnblockedItems(), getUnblockedItemsEffect(), getUnblockedItemsSync(), isTaskReady(), isTaskReadyEffect(), isTaskReadySync(), TERMINAL_STATUSES (+105 more)

### Community 28 - "Docker Stats and Container Resources"
Cohesion: 0.03
Nodes (103): conversationsTab, firstLens, firstSessionPanel, firstWorkbench, lens, overview, renderCommandDeck(), tablist (+95 more)
...
Cohesion: 0.04
Nodes (104): showCommand(), buildHostOverrideConfirmation(), confirmDropRecovery(), confirmHostOverride(), difficultyColor(), dryRun(), isSwarmRecoverAction(), parseFiniteInteger() (+96 more)

### Community 31 - "Cost Calculation and Token Usage"
Cohesion: 0.04
Nodes (96): buildCorrelationMap(), buildCorrelationMapSync(), CorrelationResult, embedAction(), confirmCost(), enrichAction(), formatCost(), scanAction() (+88 more)

### Community 32 - "Cost Events Database and WAL Sync"
Cohesion: 0.03
Nodes (101): updateTtsConfig(), defaults, first, issueAgentTypes, { models }, second, clearConfigCache(), getGlobalConfigPath() (+93 more)

### Community 33 - "VBrief Beads IO and Plan Finalize"
Cohesion: 0.03
Nodes (92): DetailPanelLayout(), DetailPanelLayoutProps, loadPanelState(), PanelMode, PanelState, savePanelState(), onPlan, button (+84 more)

### Community 34 - "Project Tree Feature Items UI"
Cohesion: 0.03
Nodes (102): activeSpec, agent2, baseAgent, baseSpecialist, bigOutput, events, existing, issues (+94 more)

### Community 35 - "Review Round Status Badge UI"
Cohesion: 0.04
Nodes (103): TurnDiffFileChange, ConversationList(), listConversations(), listFavoritedIds(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse (+95 more)

### Community 36 - "Conversation Service WebSocket RPC"
Cohesion: 0.03
Nodes (94): EventMetadata, ReadEventsOptions, tailEvents(), tailEventsSync(), authorized(), eventsRouteLayer, formatFrame(), getEventStreamRoute (+86 more)

### Community 37 - "Dashboard Design Docs and Mockups"
Cohesion: 0.04
Nodes (89): oldTimestamp, db, makeTestLayer(), makeTestService(), received, runWithService(), store, svc (+81 more)

### Community 38 - "CLI Install DNS and Dev Commands"
Cohesion: 0.03
Nodes (80): findVendoredDir(), getCavemanHooksDir(), getCavemanSkillsDir(), setupCavemanCompressScripts(), setupCavemanHooks(), CavemanVariant, existingSkillDir, existsInTarget (+72 more)

### Community 39 - "Cost Event Aggregation and Retention"
Cohesion: 0.03
Nodes (83): mockGetAgentHealth, entry, { issueId }, { limit }, old, op, ops, recent (+75 more)

### Community 40 - "Chat Messages Timeline Rendering"
Cohesion: 0.04
Nodes (92): findProjectRoot(), estimateCost(), decideChannelsForWorkAgent(), loadConfig(), applyEnvironmentFallbacks(), applyMigrations(), backupGlobalConfig(), CavemanConfig (+84 more)
...
Cohesion: 0.04
Nodes (83): ContainerDetailPanel(), ContainerDetailPanelProps, ContainerDetails, DetailTab, fetchContainerDetails(), formatBytes(), fetchMock, MOCK_ISSUE (+75 more)

### Community 44 - "Chat Composer Model Picker"
Cohesion: 0.04
Nodes (73): InlineSparkline(), InlineSparklineProps, format(), LiveCounter(), LiveCounterProps, REVIEWER_STYLE, ReviewerRole, RoleBadge() (+65 more)

### Community 45 - "Cloister Config Deep Merge"
Cohesion: 0.04
Nodes (83): ChangedFilesTree, collectDirectoryPaths(), EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ConversationEvent, ProposedPlan, TurnDiffFileChange (+75 more)
...
Cohesion: 0.05
Nodes (75): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFile(), writeFeedbackFilePromise(), WriteFeedbackOptions (+67 more)

### Community 48 - "Workspace and Version API Routes"
Cohesion: 0.04
Nodes (77): PRIORITY_LABELS, resolveTrackerType(), PlanningIssue, buildChildStoriesFromRally(), buildCloseOutContext(), buildLifecycleContext(), cleanupAgentStateDirs(), CLOSED_OUT_CACHE_WORKFLOW_LABELS (+69 more)

### Community 49 - "Model Selection and Subscription Policy"
Cohesion: 0.04
Nodes (71): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), createHandoffPaths(), ensureHandoffsDir() (+63 more)

### Community 50 - "Project Resolution and Review Enrichment"
Cohesion: 0.04
Nodes (62): mockClaudeSkills, contextSyncCommand(), BUNDLED_GIT_HOOKS_DIR, __dirname, __filename, syncCommand(), SyncOptions, applyManagedRegion() (+54 more)

### Community 51 - "Codex Agent Spawn UI Flow"
Cohesion: 0.08
Nodes (81): killTmuxSession(), canonicalPrdSubdir(), canonicalPrdSubdirSync(), findPrdAtStatus(), findPrdAtStatusSync(), statusRoot(), removeWorktree(), archivePlanning() (+73 more)
...
Cohesion: 0.04
Nodes (69): relativeTime(), ShowOptions, adminRouteLayer, getAdminTldrRoute, postAgentMessageLikeRoute(), validateAgentMessageOrigin(), conversationsRouteLayer, handleConversationHandoffDoc() (+61 more)

### Community 55 - "Settings Provider and Model Browser UI"
Cohesion: 0.04
Nodes (66): getGlobalRouter(), anthropicModel, anthropicRouter, apiKeys, { config }, config1, config2, documentationResult (+58 more)

### Community 56 - "Multi-Tool Sync and MCP Isolation"
Cohesion: 0.04
Nodes (61): { projectPath, workspacePath }, promoted, specFiles, doc, makeDoc(), path, doc, found (+53 more)

### Community 57 - "Issue Tracker Polling Service"
Cohesion: 0.05
Nodes (65): getModelStyle(), ModelBadge(), Framer Motion animation library, ActivityFeed(), ActivityFeedProps, EVENT_COLORS, EVENT_ICONS, fetchActivityREST() (+57 more)

### Community 58 - "Fly Remote Provider and API Client"
Cohesion: 0.06
Nodes (67): assertSafeAgentId(), assertSafeAgentIdEffect(), assertSafeAgentIdProgram(), captureCheckpoint(), captureCheckpointEffect(), captureCheckpointPromise(), CheckpointGitResult, checkpointRef() (+59 more)

### Community 59 - "Settings Page Model Override and Auth"
Cohesion: 0.04
Nodes (69): MODELS_BY_PROVIDER, CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), CodexAuthStatus (+61 more)
...
Cohesion: 0.05
Nodes (65): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextValidateCommand(), LayerName (+57 more)

### Community 62 - "System Health and Spawn Guardrails"
Cohesion: 0.05
Nodes (64): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, cleanFile(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects() (+56 more)

### Community 63 - "Server Cache Service and Chat Markdown"
Cohesion: 0.05
Nodes (68): confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation(), execAsync, execFileAsync, failPostCreateValidation(), fetchIssueForAutoStart(), findWorkspace() (+60 more)

### Community 64 - "Diff Panel Rendering and Theming"
Cohesion: 0.04
Nodes (66): Agent Enrichment Service, agentDir, missing, result, snapshot, status, filterClosedIssueAgents(), discoverNewAgentIds() (+58 more)
...
Cohesion: 0.09
Nodes (67): bridgeCodexAuthToCliproxy(), bridgeCodexAuthToCliproxyAsync(), bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxy(), bridgeGeminiAuthToCliproxyAsync(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig() (+59 more)

### Community 68 - "Workspace Teardown and Label Cleanup"
Cohesion: 0.05
Nodes (67): claimTranscriptRange(), claimTranscriptRangeAsync(), commitTranscriptRange(), commitTranscriptRangeAsync(), getTranscriptCheckpoint(), getTranscriptCheckpointAsync(), listTranscriptCheckpoints(), listTranscriptCheckpointsAsync() (+59 more)

### Community 69 - "Swarm Dispatch and DAG Execution"
Cohesion: 0.05
Nodes (56): markEnrichmentFailed(), buildConversationExcerpt(), buildL1Prompt(), buildL2Prompt(), buildL3Prompt(), callClaudeApi(), callClaudeApiWithConfig(), EnrichmentApiConfig (+48 more)

### Community 70 - "Settings Persistence and Model Defaults"
Cohesion: 0.05
Nodes (63): CloisterStatus, fetchConversations(), GeneralConversation, GeneralSectionProps, fetchConversations(), ActivityEntry, AgentList(), AgentListProps (+55 more)
...
Cohesion: 0.05
Nodes (59): AlertDialogContent(), AlertOptions, ConfirmDialogContent(), ConfirmOptions, DialogContext, DialogContextValue, DialogProvider(), DialogShell() (+51 more)
...
Cohesion: 0.05
Nodes (61): UpsertDiscoveredSessionOpts, startRealConversationRoutes(), validateAgentDeliveryMethodOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader(), getDashboardSessionToken() (+53 more)
...
Cohesion: 0.06
Nodes (62): Command Deck (Core Concept), PAN-965 Command Deck Resource Tree PRD, PAN-966 Open-in-Editor Integration PRD, Dashboard Typography Cleanup PRD, Project Overview Panel PRD, Command Deck, ActivityContext, awaitingInputFromProjection() (+54 more)
...
Cohesion: 0.07
Nodes (54): skills, updateCommand(), buildManifestFromDirectory(), collectSourceFiles(), collectSourceFilesSync(), compareFileToManifest(), createEmptyManifest(), hashFile() (+46 more)

### Community 82 - "Model Routing and Complexity Detection"
Cohesion: 0.07
Nodes (52): createMemoryCommand(), buildDailySummaryMarkdown(), createResetMarker(), DailySummaryResult, DailySummaryStatus, dedupeResetMarkers(), generateDailySummary(), getMemoryStatus() (+44 more)
...
Cohesion: 0.07
Nodes (56): ensureDashboardBundle(), traefikDir, devCommand(), __dirname, ensureDashboardBundle(), killPort(), readConfig(), resolveNode22() (+48 more)

### Community 85 - "Conversation Compaction and Fork Pipeline"
Cohesion: 0.05
Nodes (55): setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), withConcurrencyLimit(), setPipelineHandler(), setPipelineHandlerSync(), closeMemoryFtsDatabases(), stopTranscriptPoller(), getEventStore() (+47 more)

### Community 86 - "Cloister Orchestrator Architecture PRDs"
Cohesion: 0.05
Nodes (54): getCavemanExperimentData(), httpHandler(), HttpServerResponse, ReadModelServiceLive, AgentSpawner, AgentSpawnerLive, AgentSpawnerShape, DeepWipeOptions (+46 more)
...
Cohesion: 0.07
Nodes (46): doneCommand(), DoneOptions, execAsync, isMergeSetMergedIntoTargets(), updateGitHubToInReview(), updateLinearToInReview(), wipeCommand(), WipeOptions (+38 more)
...
Cohesion: 0.05
Nodes (35): CapabilityModelId, getModelCapability(), getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, allModels (+27 more)

### Community 95 - "Command Deck Action Registry Pipeline"
Cohesion: 0.04
Nodes (49): changedFiles, errOutput, fetchMock, output, exec(), execMock, execResponses, kCustom (+41 more)

### Community 96 - "Rally Tracker Adapter Tests"
Cohesion: 0.06
Nodes (52): normalize(), unarchiveConversationCommand(), remaining, AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment (+44 more)
...
Cohesion: 0.05
Nodes (44): detectFirstAvailableEditor(), Editor, getFileManagerCommand(), isCommandAvailable(), loadEditors(), openCommand(), SearchResult, RuntimeConversationsConfig (+36 more)

### Community 99 - "Desktop Menu and Auto-Updater Lifecycle"
Cohesion: 0.06
Nodes (44): DbMergeSetRepoRow, DbMergeSetRow, deleteMergeSet(), getAllMergeSetsFromDb(), getMergeSetFromDb(), getReposFromDb(), rowToMergeSet(), makeMergeSet() (+36 more)

### Community 100 - "Issue ID Parsing and Agent Cleanup"
Cohesion: 0.07
Nodes (46): backup, configFile, backupCleanCommand(), backupListCommand(), restoreCommand(), BackupInfo, cleanOldBackups(), cleanOldBackupsSync() (+38 more)
...
Cohesion: 0.07
Nodes (41): content, mockExeca, CloseIssueOptions, compactBeads(), compactBeadsImpl(), execAsync, { mockExecAsync }, ApproveOptions (+33 more)
...
Cohesion: 0.05
Nodes (46): runMemoryFtsTransaction(), emitMemoryHealthChanged(), EMPTY_HEALTH, getMemoryHealthPath(), MemoryHealthChangedPayload, MemoryHealthSnapshot, MemoryHealthStatus, MemoryHealthUpdate (+38 more)

### Community 107 - "Config Migration and Test Agent"
Cohesion: 0.06
Nodes (40): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+32 more)

### Community 108 - "Specialist Agent Health Dashboard UI"
Cohesion: 0.08
Nodes (50): appendBridgeLog(), BunGlobal, ChannelPermissionRequest, ChannelPermissionRequestNotification, ChannelPushPayload, ChannelPushResult, constantTimeHeaderMatch(), forwardPermissionRequestToDashboard() (+42 more)

### Community 109 - "Cloister Pipeline Unit Tests"
Cohesion: 0.06
Nodes (48): API_ERROR_PATTERNS, buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, deliverReviewVerdictFeedbackPromise(), DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis() (+40 more)
...
Cohesion: 0.07
Nodes (47): AutoResumeConfig, DEFAULT_AUTO_RESUME_CONFIG, normalizeAutoResumeConfig(), positiveNumber(), validBackoffSchedule(), config, customConfig, invalidEntryConfig (+39 more)
...
Cohesion: 0.08
Nodes (42): buildInspectPrompt(), buildInspectPromptPromise(), detectCompileCommand(), __dirname, execAsync, execFileAsync, __filename, getBeadDescription() (+34 more)
...
Cohesion: 0.07
Nodes (44): AgentCard(), AgentCardProps, AgentPhase, AGENT_DEFINITIONS, AgentCardsPanel(), AgentCardsPanelProps, Capability, CAPABILITY_INFO (+36 more)
...
Cohesion: 0.08
Nodes (42): shellQuote(), verifyMergedBeforeLifecycle(), getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments() (+34 more)
...
Cohesion: 0.06
Nodes (38): VoiceMode, VoiceWidget(), Conversation, ConversationListProps, fetchConversations(), getSortKey(), ListTab, loadSort() (+30 more)

### Community 124 - "Reviewer Tree and Command Deck Dashboard"
Cohesion: 0.09
Nodes (17): cachedIssue, issues, octokitMocks, result, importTrackerConfig(), GitHubConfig, RallyConfig, getCanonicalStatus() (+9 more)

### Community 125 - "Agent Health Event Persistence"
Cohesion: 0.07
Nodes (40): parseContainerServiceName(), parseContainerServiceNameSync(), parseIssueIdFromText(), parseIssueIdFromTextSync(), isBenchmarkMode, startedAt, computeResourceAllocatedIssues(), discoverResourceAllocatedIssues() (+32 more)
...
Cohesion: 0.07
Nodes (38): systemHealthCommand(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunning(), isSmeeProcessRunningSync() (+30 more)

### Community 132 - "Conversation Smart Compaction"
Cohesion: 0.08
Nodes (39): showHelp(), startCommand(), statusCommand(), stopCommand(), tldrCommand(), TldrOptions, warmCommand(), getCloisterService() (+31 more)

### Community 133 - "Conversation Attachment Lifecycle Management"
Cohesion: 0.04
Nodes (37): isShadowWorkspace(), beads, createCall, createCalls, dbError, deleteCalls, doc, doctorCalls (+29 more)
...
Cohesion: 0.06
Nodes (35): ActivityFeedCard(), ActivityFeedCardProps, BucketSection(), BucketSectionProps, AGENT_ICON_PROVIDER, AGENT_LABELS, AgentState, ConversationFeedCard() (+27 more)
...
Cohesion: 0.09
Nodes (43): buildReleaseNotesMarkdown(), contractsPackageJsonPath, desktopPackageJsonPath, __dirname, ensureCleanTree(), ensureMainBranch(), ensureTagDoesNotExist(), __filename (+35 more)
...
Cohesion: 0.07
Nodes (34): StandaloneTerminal(), StandaloneTerminalProps, ContextMenuState, debounce(), isMac, TERMINAL_PROFILE_ENABLED, TerminalSizeMessage, TerminalSnapshotMessage (+26 more)
...
Cohesion: 0.09
Nodes (35): getReviewAgents(), ReviewContext, reviewResultToReviewStatus(), detectBranch(), detectFilesChanged(), detectPrUrl(), detectPrUrlForRepo(), execAsync (+27 more)
...
Cohesion: 0.07
Nodes (33): BYTE_UNITS, cachedContainerLifecycleSnapshot, ContainerHistory, ContainerStats, DockerContainerLifecycle, DockerNetwork, DockerPsRaw, DockerStatsCollector (+25 more)
...
Cohesion: 0.05
Nodes (41): Claude Code Harness, Pi Coding Agent Harness, Harness Policy - Pi+Anthropic+Subscription Blocked, Model Routing via Work Types, Anthropic Provider (Claude), Google Provider (Gemini), Kimi (Moonshot) Provider, OpenAI Provider (Codex/GPT) (+33 more)

### Community 174 - "Specialist Context Digest Generation"
Cohesion: 0.05
Nodes (39): ghCliIssue, githubApiIssue, githubOpenIssue, issueWithCompletedAt, issueWithoutCompletedAt, linearIssue, linearOpenIssue, mappedIssue (+31 more)
...
Cohesion: 0.06
Nodes (27): readLogTail(), appendJsonl(), ExtractFromTranscriptDeltaResult, countCompleteLines(), defaultTranscriptPoller, isSuccessfulExtractionResult(), readTranscriptSlice(), RegisteredTranscript (+19 more)
...
Cohesion: 0.07
Nodes (35): ActivitySection, AgentSection(), AgentSectionProps, formatCost(), formatDuration(), formatModel(), formatTime(), getPreviewLine() (+27 more)
...
Cohesion: 0.08
Nodes (36): number(), GLOBAL_CONFIG_PATH, Platform, captureTheme(), main(), parseArgs(), THEMES, runNumber() (+28 more)

### Community 185 - "Git Forge PR and MR Artifact Creation"
Cohesion: 0.09
Nodes (36): doctorCommand(), checkClosedIssueOrphanAgentDirs(), checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult (+28 more)
...
Cohesion: 0.15
Nodes (28): RemoteProviderConfig, Issue, config, originalEnv, tracker, AnyTrackerError, Comment, Issue (+20 more)
...
Cohesion: 0.05
Nodes (36): consoleSpy, mirrorLog, mockCheckDevrootDeprecation, mockCleanupAgentDirectories, mockCleanupLegacyRuntimeSymlinks, mockCreateBackup, mockEnsureExcalidrawMcp, mockEnsurePlaywrightIsolation (+28 more)
...
Cohesion: 0.08
Nodes (33): SpecialistHealthState, DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), formatLogTime(), formatSpecialistName() (+25 more)

### Community 214 - "Caveman Skill Compression Validation"
Cohesion: 0.11
Nodes (35): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, ForkProgressView() (+27 more)
...
Cohesion: 0.08
Nodes (25): derivePlanningIssueId(), fetchOutput(), popoutTerminal(), TerminalPanel(), TerminalPanelProps, agent, queryClient, renderTerminalPanel() (+17 more)

### Community 224 - "Cost Tracking Architecture Docs"
Cohesion: 0.13
Nodes (34): CHUNK_BUDGET_CHARS_BY_MODEL, chunkEntriesByBudget(), CompactionOptions, CompactionResult, computeFileLists(), createFileOps(), CutPointResult, estimateContextTokens() (+26 more)
...
Cohesion: 0.09
Nodes (33): CliproxyCodexCredentials, getCliproxyAuthDir(), applyBurnedTokenOverride(), CheckCodexAuthOptions, checkCodexAuthStatus(), checkCodexAuthStatusPromise(), CliproxyCodexCredentials, CodexAuthBurned (+25 more)
...
Cohesion: 0.1
Nodes (31): activeViolations, checkAgentForViolations(), clearOldViolations(), clearOldViolationsEffect(), clearOldViolationsSync(), DEFAULT_FPP_CONFIG, FPPViolation, FPPViolationConfig (+23 more)
...
Cohesion: 0.07
Nodes (31): healths, CloisterEvent, setCloisterService(), capturedEvents, consoleSpy, customService, emergencyEvent, health (+23 more)
...
Cohesion: 0.09
Nodes (30): createDatabase(), databases, deferSqliteWork(), getMemoryFtsDatabase(), getMemoryFtsWorker(), initializeMemoryFtsSchema(), isBunRuntime(), MemoryFtsStatement (+22 more)
...
Cohesion: 0.1
Nodes (27): err, beads, capturedArgs, err, mockExecFileFn, mockExecFn, hiddenDir, mockExecFn (+19 more)

### Community 262 - "Panopticon 1.0 Stabilization Audit"
Cohesion: 0.08
Nodes (28): ApiKeysConfig, ProviderCard(), ProviderCardProps, PROVIDER_INFO, ProviderPanel(), ProviderPanelProps, THINKING_LEVEL_LABELS, THINKING_LEVELS (+20 more)
...
Cohesion: 0.09
Nodes (28): approveReviewArtifact(), approveReviewArtifactEffect(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), commentOnArtifactEffect(), CommentOnArtifactInput, createReviewArtifact() (+20 more)
...
Cohesion: 0.1
Nodes (29): CategoryFilter, formatContextLength(), formatCost(), ModelCard(), OpenRouterModel, OpenRouterModelBrowser(), OpenRouterModelBrowserProps, fetchOpenRouterModels() (+21 more)
...
Cohesion: 0.1
Nodes (28): getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate() (+20 more)

### Community 278 - "Feature Metadata Badge and Modal Components"
Cohesion: 0.06
Nodes (29): base, cols, colsAfter, colsBefore, correctedPath, index, names, row (+21 more)
...
Cohesion: 0.06
Nodes (25): cache, capped, cpuList, events, lines, memFree, memTotal, result (+17 more)
...
Cohesion: 0.12
Nodes (12): LRUCache, openSqliteDb(), _require, isStale(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+4 more)
...
Cohesion: 0.06
Nodes (25): cb, cmdArgs, cmdStr, inline, issueCommentsJson, linearGetComments, linearGetIssueId, mockExec (+17 more)
...
Cohesion: 0.12
Nodes (25): AwaitingInputDetection, AwaitingInputReason, compactPrompt(), detectAwaitingInputForAgentPromise(), detectAwaitingInputFromPane(), detectAwaitingInputFromPaneSync(), findPermissionMenuEndIndex(), getPaneDetectionCacheKey() (+17 more)
...
Cohesion: 0.12
Nodes (28): getCachedDockerContainerLifecycleObservedAt(), getCachedDockerContainerLifecycleSnapshot(), out, match, out, collectDockerContainerLifecycleSnapshot(), createdAgeMs(), defaultWorkspacePath() (+20 more)
...
Cohesion: 0.14
Nodes (26): drainPendingEvents(), envFor(), getDashboardUrl(), handlePanDone(), handleSessionStart(), handleToolExecutionEnd(), handleTurnEnd(), HookEnv (+18 more)

### Community 327 - "Dashboard Motion Animation Catalog"
Cohesion: 0.1
Nodes (22): buildMergeAgentMemory(), buildMergeAgentMemoryPromise(), checkAndRotateIfNeeded(), checkAndRotateIfNeededPromise(), DEFAULT_MEMORY_TIERS, execAsync, MemoryTiers, MergeRecord (+14 more)

### Community 328 - "Testing Guide and Conventions Docs"
Cohesion: 0.09
Nodes (25): generateFallbackSummary(), claudeProjectDir, content, lines, newContent, newSessionFile, oldContent, oldSessionFile (+17 more)
...
Cohesion: 0.08
Nodes (21): fetchProjectSpecialists(), fetchProjectSpecialists(), fetchRunLogs(), formatDate(), ProjectSpecialist, ProjectSpecialistCard(), ProjectSpecialistCardProps, ProjectSpecialistMetadata (+13 more)
...
Cohesion: 0.17
Nodes (20): FsError, readWorkspaceContext(), writeWorkspaceContext(), ensureWorkspacePanDir(), getWorkspacePanPaths(), readWorkspaceContinue(), uniqueTmpPath(), validateWorkspaceContinueState() (+12 more)
...
Cohesion: 0.1
Nodes (16): WorkspaceService, MOCK_PROJECT, mockCreateWorkspace, mockExistsSync, mockLoadProjectsConfig, mockRemoveWorkspace, mockStopWorkspaceDocker, program (+8 more)
...
Cohesion: 0.13
Nodes (20): displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), dedupeRows(), listCommand(), getTrackerConfig(), getTriageStatePath() (+12 more)
...
Cohesion: 0.15
Nodes (17): shadowCommand(), cleanupTestFiles(), getUniqueId(), result, TEST_SHADOW_STATE_DIR, getDisplayStatus(), getUnsyncedHistory(), needsSync() (+9 more)
...
Cohesion: 0.16
Nodes (9): collectMail(), collectMailSync(), getHookDir(), getMailDir(), initHook(), initHookSync(), sendMail(), sendMailSync() (+1 more)
...
Cohesion: 0.1
Nodes (15): calls, calls, { mockExecAsync }, opts, CompactBeadsOptions, calls, ctx, mockClientCreateIssueLabel (+7 more)

### Community 498 - "Community 498"
Cohesion: 0.17
Nodes (19): CavemanExperimentRow, CostsPage(), DailyTrend, ExperimentsResponse, ExperimentsView(), fetchCosts(), fetchExperiments(), fetchIssueDetail() (+11 more)
...
Cohesion: 0.17
Nodes (11): configShadowCommand(), ShadowOptions, ENV_FILE_PATH, getShadowModeFromEnv(), loadPanopticonEnv(), loadPanopticonEnvSync(), parseEnvFile(), getShadowModeSummaryPromise() (+3 more)

### Community 545 - "Community 545"
Cohesion: 0.12
Nodes (13): err, estimated, largePath, lines, progressCalls, prompts, samplePath, secretPath (+5 more)
...
Cohesion: 0.15
Nodes (14): emitDashboardLifecycleSync(), data, mockExistsSync, mockReadFile, mockUnlink, runner, mockUnlinkSync, mockReadFileSync (+6 more)
...
Cohesion: 0.23
Nodes (13): planCommand(), PlanOptions, runDiscoveryPhase(), analyzeComplexity(), ComplexityAnalysis, copyToPRDDirectory(), DiscoveryDecision, executePlan() (+5 more)

### Community 573 - "Community 573"
Cohesion: 0.16
Nodes (14): logSpy, now, output, payload, {
  shadowMock, cvMock, contextMock, healthMock,
  getShadowStateMock, pingAgentMock, getAgentCVMock, getAgentRuntimeStateMock,
}, logSpy, cleanupShadowTestFiles(), { getRuntimeForAgentMock, getAgentHealthMock } (+6 more)
...
Cohesion: 0.22
Nodes (14): applyOutcome(), checkpointIdentity(), emptyResult(), GetAgentRuntimeState, getAgentRuntimeStateFromStore(), GetAgentState, getAgentStateFromStore(), MemoryReconciliationResult (+6 more)
...
Cohesion: 0.21
Nodes (15): Conversation, getConversationByClaudeSessionId(), markConversationEnded(), setClearedToConvId(), AgentStateFile, backfillOrphanedSpecialistConversations(), detectOrphanedClaudeCodeSessions(), findClaudeSessionUuid() (+7 more)
...
Cohesion: 0.12
Nodes (15): CostsResponse, ACTIVITY_RESPONSE, AGENTS_RESPONSE, COSTS_RESPONSE, DISCUSSIONS_RESPONSE, ISSUES_RESPONSE, PLANNING_RESPONSE, PR_DIFF_RESPONSE (+7 more)
...
Cohesion: 0.18
Nodes (12): FeedbackKind, isDeliveryStillRelevant(), PENDING_FEEDBACK_FILE, PendingFeedbackDelivery, PendingFeedbackStore, processPendingFeedbackDeliveries(), delivery, deliver (+4 more)
...
Cohesion: 0.15
Nodes (12): afterCommit, beforeCommit, execAsync, revertedCommit, scriptPath, execAsync, initialCommit, mergeCommit (+4 more)
...
Cohesion: 0.27
Nodes (11): encodeClaudeProjectDir(), pathExists(), pickFreshestSessionId(), readOptional(), resolveClaudeSessionId(), resolveJsonlPath(), ResolveJsonlPathOptions, projectDir (+3 more)
...
Cohesion: 0.2
Nodes (10): cliPromptsDir, copyCavemanAssets(), copyCloisterPrompts(), copyMatching(), copyPrompts, dashboardDir, distDir, preservedDashboardDir (+2 more)
...
Cohesion: 0.23
Nodes (11): ModelBreakdown, CostBreakdownData, CostBreakdownModal(), CostBreakdownModalProps, formatCost(), formatTokens(), friendlyModelName(), ModelBreakdown (+3 more)
...
Cohesion: 0.29
Nodes (8): DEFAULTS, DiffIndicators, DiffPreferences, DiffRenderMode, HunkSeparators, LineDiffType, LineHoverHighlight, useDiffPreferences()
...
Cohesion: 0.36
Nodes (8): refreshCommand(), refreshFromLinear(), RefreshOptions, isLinearIssue(), updateTrackerStatusCache(), formatState(), getLinearApiKey(), isLinearIssue()
...
Cohesion: 0.22
Nodes (10): Work Agent (shown in inspector terminal), Deacon UAT Container Crash Recovery (noted in inspector), Inspector Panel with Live Agent Terminal, Kanban Columns: To Do, In Progress, In Review, Done, Budget Today Metric ($223.86 shown in header), Panopticon Dashboard Kanban Board (Hero), Inspector Panel Attempt (Kanban + Inspector Side-by-Side), Inspector Panel with Agent Terminal (PAN-655) (+2 more)
...
Cohesion: 0.67
Nodes (3): code:bash (pan plan done PAN-1071), Completing planning (`pan plan done`), Step 5: Review Plan
...
## Knowledge Gaps
- **13746 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `CLI_DIST` (+13741 more)
...
- **Why does `string()` connect `Merge Agent Post-Merge Lifecycle` to `Agent Session Lifecycle Management`, `Command Deck Overview Tab UI`, `Deacon Patrol and Queue`, `VBrief Plan Builder and Viewer`, `Parallel Review Pipeline Dispatch`, `Specialist Handoff and Planning Spawn`, `Workspace Creation and Worktree`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Inspector Panel Terminal UI`, `Kanban Board Agent Status UI`, `Health Metrics and Settings Pages`, `Issue Service and Data Fetching`, `Workspace Lifecycle and Config`, `Git Activity and Runtime Metrics`, `Dialog Actions and System Health UI`, `Specialist Metadata and Grace Period`, `CLI Commands and Runtime Adapters`, `Command Deck Zone B Session Nodes`, `GodView Socket and Activity Feed`, `Cost Calculation and Token Usage`, `Cost Events Database and WAL Sync`, `Community 546`, `Dashboard Design Docs and Mockups`, `Cloister Service Handoff Logging`, `Workspace and Version API Routes`, `Model Selection and Subscription Policy`, `Project Resolution and Review Enrichment`, `Codex Agent Spawn UI Flow`, `Config Loading and Merging`, `Platform Supervisor Startup Lifecycle`, `Issue Tracker Polling Service`, `Fly Remote Provider and API Client`, `Community 572`, `Community 1087`, `Diff Panel Rendering and Theming`, `Server Cache Service and Chat Markdown`, `GitHub Webhook Ingestion Handlers`, `GitHub Client and Agent Spawner`, `Workspace Teardown and Label Cleanup`, `Swarm Dispatch and DAG Execution`, `Settings Persistence and Model Defaults`, `Resource Process Discovery and Reporting`, `Read Model Enrichment and Agent Snapshots`, `Resource-Allocated Issue Discovery`, `Skills Merge and Manifest Sync`, `Plan DAG Visualization and Beads Panel`, `Work Agent Prompt and Reopen Flow`, `Frontend Dashboard Component Tests`, `Cliproxy Process Lifecycle Management`, `Rally Tracker Adapter Tests`, `Conversation Panel and Chat Phase Types`, `Cost Data Migration and Reconciliation`, `Claude OAuth Authentication and Settings`, `Specialist Agent Health Dashboard UI`, `Cloister Pipeline Unit Tests`, `Specialist Pipeline PRDs and Skills`, `Smee Webhook Proxy Process Management`, `Specialist Agent Prompts and Audit Docs`, `Caveman Hooks and Workspace Setup`, `Community 632`, `Community 634`, `FPP Policy Violation Detection and Nudging`, `Community 638`, `Rally Tracker API Integration`, `Conversation Smart Compaction`, `Configuration Documentation`, `Agent Card Model Defaults Display`, `Dangerous Git Operations Safety Guards`, `Agent CV and Show Commands`, `Issue Filtering and Model Fallback Tests`, `Git Forge PR and MR Artifact Creation`, `Community 705`, `Community 709`, `Shadow State Refresh Commands`, `Cost Tracking Architecture Docs`, `Community 744`, `Review Test Merge Pipeline Docs`, `Git Lock File Utilities`, `Pending Lifecycle Event Processing`, `Project Setup and Polyrepo Workspace PRDs`, `Command Deck Overview Playwright Snapshots`, `Agent Show Command Tests`, `External SSE Event Stream and God View`, `Kanban Board UI Screenshots`, `Git Rebase and Conflict Resolution`, `Experimental Channels Toggle Tests`, `Issue Cost Resolution and Normalization`, `Workspace Reopen and State Reset`, `t3code Architecture Alignment Research`, `Zone C Dashboard Tab Tests`, `Dashboard Motion Animation Catalog`, `Community 859`, `Linear Issue States Tests`, `Smart Selection Explainer UI`, `Community 408`, `Community 411`, `Community 412`, `Community 932`, `Community 439`, `Community 440`, `Community 441`, `Community 479`, `Community 496`, `Community 498`, `Community 499`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `ConversationEvent` connect `Review Round Status Badge UI` to `Agent Session Lifecycle Management`, `Community 640`, `Command Deck Overview Tab UI`, `Merge Agent Post-Merge Lifecycle`, `Panopticon 1.0 Stabilization Audit`, `Conversation Database and Favorites`, `Cloister Service Health and Config`, `Event Store Domain Services`, `Tmux Terminal Session Management`, `Database Schema and Review Status`, `Dashboard HTTP Routes and Admin`, `VBrief Beads IO and Plan Finalize`, `Agent Card Model Defaults Display`, `Conversation Service WebSocket RPC`, `Community 679`, `Chat Messages Timeline Rendering`, `Work Type Routing and Config`, `Chat Composer Model Picker`, `Cloister Config Deep Merge`, `Model Selection and Subscription Policy`, `Project Living Memory PRD`, `Platform Supervisor Startup Lifecycle`, `Multi-Tool Sync and MCP Isolation`, `Issue Tracker Polling Service`, `Fly Remote Provider and API Client`, `System Health and Spawn Guardrails`, `Agent List and Handoff Status UI`, `Community 582`, `Settings Persistence and Model Defaults`, `Testing Guide and Conventions Docs`, `Merge Queue and App Settings Database`, `Path Constants and Postinstall Setup`, `Activity Panel and VTT Parsing`, `Specialist Commands and VBrief Index`, `Caveman Skill Compression Validation`, `Cloister Orchestrator Architecture PRDs`, `Cliproxy Process Lifecycle Management`, `Event Snapshot Cache and State Reducers`, `User Documentation and Provider Guides`, `Community 605`, `Rally Tracker Adapter Tests`, `Diagnostic and Incident Response Skills`, `Database Settings and Cost Unit Tests`, `Issue ID Parsing and Agent Cleanup`, `Community 491`, `Issue Planning and Tracker Resolution`, `Pending Lifecycle Event Processing`, `FPP Policy Violation Detection and Nudging`, `TTS Daemon and Pi Extension Supervisor`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `pan done Command` connect `Dashboard HTTP Routes and Admin` to `Agent Feedback Delivery and Logging`, `Settings Persistence and Model Defaults`, `Cost Recovery Scripts and Latency Tests`, `VBrief Task Readiness and Beads IO`, `Frontend Fetch Retry with Backoff`?**
...
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13746 weakly-connected nodes found - possible documentation gaps or missing edges._
