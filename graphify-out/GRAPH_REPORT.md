...
## Corpus Check
- 1983 files · ~3,187,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28245 nodes · 44505 edges · 1312 communities (1257 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 824 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d0afb1f`
...
## Communities (1312 total, 55 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (203): DeaconLogEntry, DeaconStatus(), DeaconStatusData, fetchDeaconLogs(), fetchDeaconStatus(), LOG_LEVEL_COLORS, LOG_LEVEL_LABELS, SpecialistHealthState (+195 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (168): AgentOutputPanel(), AgentOutputPanelProps, deriveAgentIssueId(), fetchAgentConversation(), parseSpecialistSession(), AwaitingMergePage(), AwaitingMergeRow(), BlockedMergeRow() (+160 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (155): annotationsMap, appendAll, boolTag, BREAK, byReferenceInstances, catchCause, catchIf, catchTag$1 (+147 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (148): ARCHIVE_EXTENSIONS, CODE_EXTENSIONS, CONFIG_EXTENSIONS, escapeHtml(), extensionOfPath(), FileLinkIcon, fileLinkIconForPath(), highlightQuickviewCode() (+140 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (162): ACTIVE_STATUS_PATTERNS, addLog(), API_ERROR_PATTERNS, apiErrorRecoveryState, autoCloseOut(), autoCloseOutCache, autoResumeStoppedWorkAgents(), checkAndSuspendIdleAgents() (+154 more)
...
Cohesion: 0.02
Nodes (108): getHealthThresholdsMs(), checkUndispatchedShip(), DeaconLogEntry, getDeaconLogs(), getLastPatrolResult(), PatrolResult, stopDeacon(), activeViolations (+100 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (155): buildInspectPrompt(), buildInspectPromptPromise(), __dirname, execAsync, execFileAsync, __filename, getBeadDescription(), InspectResult (+147 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (115): activeAgent, cafSpy, client, menu, onNavigateToIssues, rafSpy, scrollSpy, tiles (+107 more)
...
Cohesion: 0.02
Nodes (119): ActivitySparkline(), ActivitySparklineProps, CATEGORY_COLORS, SparklineCategory, SparklineEvent, RecoverButton(), RecoverButtonProps, SwitchModelModal() (+111 more)
...
Cohesion: 0.02
Nodes (108): CodexAuthBanner(), SensitiveText(), SensitiveTextProps, CodexAuthStatus, fetchCodexAuthStatus(), useCodexAuthStatus(), fetchSettings(), isIssueTtsMuted() (+100 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (111): recordAutoCloseOutFailure(), recoverUnhealthyTestStack(), setAgentStatusChangedNotifier(), setAgentStoppedNotifier(), setMergeReadyNotifier(), DEACON_DIR, DEACON_STATE_PATH, _deaconState (+103 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (105): BulkActionBar(), BulkActionBarProps, BulkCloseOutProgress(), BulkCloseOutProgressProps, BulkCloseResult, BulkCloseStatus, CostBreakdownData, CostBreakdownModal() (+97 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (98): agentPhase(), AgentPhaseFilter, agentRole(), AgentsFilterState, AgentsViewMode, DropdownFilter(), FilterOption, filterSummary() (+90 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (102): FsError, deriveProjectRoot(), queueAutoCommit(), deleteContinueFile(), getContinueFilePath(), getContinuesDir(), hasContinueFile(), listContinueFiles() (+94 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (108): dropLingeringPreMergeStashes(), buildConvoyPrompt(), buildConvoyPromptPromise(), buildReviewRolePrompt(), cleanupReviewTempStash(), cleanupReviewTempStashPromise(), ensureReviewTempStash(), execAsync (+100 more)
...
Cohesion: 0.04
Nodes (89): buildPolyrepoContext(), closeOutCommand(), CloseOutOptions, execFileAsync, getGitHubConfig(), readGitHubCanonicalState(), registerTestCommands(), runCommand() (+81 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (92): appendChannelDeliveryLog(), applyAgentPaused(), applyAgentUnpaused(), clearAgentPaused(), clearAgentTroubled(), deliverAgentMessage(), deliverAgentPermissionDecision(), getAgentState() (+84 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (85): createHumeConfig(), createHumeConfigPromise(), deleteHumeConfig(), deleteHumeConfigPromise(), HumeApiError, humeFetch(), HumeResult, execAsync (+77 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (70): artifactTabs, dialogActionKeys, IssueActionDialogState, IssueActionLayout, PostActionInput, ACTION_BY_KEY, canCancelIssue(), canCloseOut() (+62 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (84): DEFAULT_AUTO_RESUME_CONFIG, applyEnvironmentOverrides(), AutoActions, AutoRestartConfig, CLOISTER_CONFIG_FILE, CloisterConfig, CloseOutConfig, CostTrackingConfig (+76 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (71): buildACLookupByTitle(), PanSpecListOptions, ProjectPanPaths, criteria, doc, result, { projectPath, workspacePath }, promoted (+63 more)
...
Cohesion: 0.03
Nodes (84): adminRouteLayer, getAdminTldrRoute, agentsRouteLayer, cloisterRouteLayer, getCloisterAgentsHealthRoute, getCloisterConfigRoute, getCloisterSpawnStatusRoute, getCloisterStatusRoute (+76 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (92): estimateCost(), defaults, first, { models }, second, ModelRef, RoleConfig, RolesConfig (+84 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (70): ChangedFilesTree, EMPTY_DIRECTORY_OVERRIDES, ChatMessage, CompactBoundary, ContextUsage, ConversationEvent, ProposedPlan, TurnDiffFileChange (+62 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (77): configShadowCommand(), ShadowOptions, displayIssues(), getConfiguredTrackers(), getTrackerConfig(), listCommand(), ListOptions, PRIORITY_LABELS (+69 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (83): execFile(), kCustom, mockExecFile, ActivityEntry, activityLog, ApprovePushResult, buildRichPRBody(), checkProjectGitSafeState() (+75 more)
...
Cohesion: 0.06
Nodes (75): extractNumberSync(), archivePlanning(), archiveWorkspaceArtifacts(), archiveWorkspaceArtifactsImpl(), movePrd(), applyClosedOutLabel(), applyLabelGitHub(), applyLabelGitHubImpl() (+67 more)
...
Cohesion: 0.04
Nodes (70): readCavemanVariant(), buildSpecialistCavemanExports(), countContextTokens(), DEFAULT_SPECIALISTS, disableSpecialist(), enableSpecialist(), ensureProjectSpecialistDir(), execAsync (+62 more)
...
Cohesion: 0.03
Nodes (69): canReplaceTitle(), listConversations(), updateForkStatus(), MessageDeliveryFailed, aboutSummaryCache, ALLOWED_UPLOAD_MIME_TYPES, ArchivedConversationResponse, backfillConversationModels() (+61 more)
...
Cohesion: 0.04
Nodes (75): UpsertDiscoveredSessionOpts, updateConversationsConfig(), postAgentMessageLikeRoute(), validateAgentMessageOrigin(), constantTimeTokenEqual(), cookieValue(), dashboardCsrfToken(), dashboardSessionCookieHeader() (+67 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (60): registerAdminCommands(), archiveCustomState(), CleanupOptions, cleanupStatesCommand(), LinearState, ListOptions, listStatesCommand(), listTeamStates() (+52 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (59): cleanFile(), configCommand(), execAsync, ExtendedProjectConfig, findFullProjectByTeam(), loadFullProjects(), seedCommand(), snapshotCommand() (+51 more)
...
Cohesion: 0.04
Nodes (48): ensureOpenAICompatibleProxyRunning(), SETTINGS_FILE, buildAnthropicMessagesUrl(), cache, CacheEntry, cacheKey(), classifyError(), classifyFetchError() (+40 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (62): normalizeFilter(), SearchMode, SearchQuery, searchSessions(), semanticCandidateWindow(), semanticRerankCandidateLimit(), showAction(), getSetting() (+54 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (66): bridgeCodexAuthToCliproxySync(), bridgeCodexAuthToCliproxyTask(), bridgeGeminiAuthToCliproxyTask(), buildCliproxyConfig(), checkCliproxyPortTask(), cliproxyCatch(), CliproxyCodexCredentials, CliproxyError (+58 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (63): startTtsDaemon(), TtsDaemonStartResult, addVoice(), addVoicePromise(), clearVoices(), clearVoicesPromise(), deleteVoice(), deleteVoicePromise() (+55 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (59): mockLoadProjectsConfig, mockRunQualityGates, PASSING_GATE_RESULT, runProjectQualityGates(), autoRevertMerge(), autoRevertMergePromise(), buildQualityGateEnv(), DASHBOARD_RUNTIME_ENV_KEYS (+51 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (54): getReviewerSessionName(), parseReviewerSessionName(), REVIEWER_ROLES, ReviewerRole, AwaitingInputDetection, result, ActivityContext, awaitingInputFromProjection() (+46 more)
...
Cohesion: 0.05
Nodes (53): startPostLaunchSidecars(), startSidecars(), computeRestartDelay(), getSmeeBinaryPath(), getSmeeUrl(), getWebhookTarget(), isProcessAlive(), isSmeeProcessRunningSync() (+45 more)
...
Cohesion: 0.06
Nodes (55): contextDiffCommand(), contextEditCommand(), contextLayersHelp(), contextListCommand(), contextMigrateCommand(), ContextOptions, contextSyncCommand(), contextValidateCommand() (+47 more)
...
Cohesion: 0.08
Nodes (63): add, addIn(), addMergeToJSMap(), addPairToJSMap(), anchorNames(), applyReviver(), array, asItemIndex() (+55 more)
...
Cohesion: 0.05
Nodes (50): createHandoffPaths(), ensureHandoffsDir(), HandoffPaths, generateSmartSummary(), copySessionFromCompactBoundary(), copySessionFromCompactBoundaryPromise(), createSummaryForkPromise(), delay() (+42 more)
...
Cohesion: 0.05
Nodes (51): announceMerge(), buildShipPreparationPrompt(), buildShipSyncMainPrompt(), captureTmuxOutput(), _completedPostMerge, defaultWorkspaceForIssue(), __dirname, execAsync (+43 more)
...
Cohesion: 0.05
Nodes (32): issues, result, importTrackerConfig(), loadReviewStatusesForIssues(), CACHE_DB_PATH, CacheEntry, CacheService, DEFAULT_TTLS (+24 more)

### Community 89 - "Community 89"
Cohesion: 0.04
Nodes (56): EDITOR_IDS, EditorEntry, EditorId, EditorIdSchema, EDITORS, OpenInEditorInput, AgentOutput, ChatMessage (+48 more)
...
Cohesion: 0.05
Nodes (39): approveReviewArtifact(), ApproveReviewArtifactInput, buildRepositoryFlag(), commentOnArtifact(), CommentOnArtifactInput, createReviewArtifact(), CreateReviewArtifactInput, CreateReviewArtifactResult (+31 more)
...
Cohesion: 0.07
Nodes (51): buildWorkAgentPrompt(), extractStitchDesigns(), matchBeadToAC(), readBeadsTasks(), readPlanningContext(), confirmHostOverride(), countBeadsTasks(), determineWorkspaceLocation() (+43 more)
...
Cohesion: 0.07
Nodes (48): checkCommand(), checkComposeLabelDrift(), checkDirectory(), checkGraphifyFreshness(), checkPi(), CheckResult, compareSemver(), ComposeDriftEntry (+40 more)
...
Cohesion: 0.07
Nodes (47): AutoResumeConfig, normalizeAutoResumeConfig(), positiveNumber(), resolveAutoResumeConfigForIssue(), validBackoffSchedule(), buildDigestPrompt(), deleteContextDigest(), ensureContextDirectory() (+39 more)
...
Cohesion: 0.06
Nodes (40): BadgeBarProps, fetchPlanning(), PlanningData, MarkdownModal(), MarkdownModalProps, TranscriptUpload(), TranscriptUploadProps, ActionKey (+32 more)
...
Cohesion: 0.07
Nodes (39): withBdMutexPromise(), withWorkspaceBdMutexPromise(), beadsDir, doc, AcceptanceCriterion, beadIdsFromList(), BeadsOperationError, clearBeadsForIssue() (+31 more)
...
Cohesion: 0.06
Nodes (27): CapabilityModelId, getModelCapabilitySync(), getValueScoreSync(), MODEL_CAPABILITIES, ModelCapability, SkillDimension, calculateSkillScore(), formatSelectionResults() (+19 more)
...
Cohesion: 0.06
Nodes (37): WorkLogEntry, ConversationPanel(), ConversationPanelProps, ConversationView(), ConversationViewProps, fetchMessages(), FORK_STEPS, MessagesResponse (+29 more)
...
Cohesion: 0.07
Nodes (33): getWindowDimensions(), startRealConversationRoutes(), activePtyHubs, addClientToHub(), broadcastToHub(), hubFlushTimer, hubOutputBuffer, PtyHub (+25 more)
...
Cohesion: 0.07
Nodes (36): normalize(), unarchiveConversationCommand(), AGENT_CONVERSATION_PREFIXES, archiveConversation(), archivedArrayIndexCondition(), ArchivedConversationListOptions, ArchivedConversationWithEnrichment, backfillConversationModel() (+28 more)
...
Cohesion: 0.06
Nodes (34): containerRestartBackoffMs(), DeaconState, killPostMergeRoleSessions(), logActivity(), sendMessageToAgent(), customPromisify, justNow, longAgo (+26 more)
...
Cohesion: 0.08
Nodes (33): killAllReviewerSessionsPromise(), killAllReviewSessionsPromise(), cleanupAgentDirectories(), cleanupAgentDirectoriesPromise(), CleanupResult, findOrphanedAgentDirs(), findOrphanedAgentDirsPromise(), getPlanningIssueId() (+25 more)
...
Cohesion: 0.11
Nodes (40): addCommentBefore(), ALIAS, anchorIsValid(), callVisitor(), createStringifyContext(), format(), formatPropertyKey(), getTagObject() (+32 more)

### Community 175 - "Community 175"
Cohesion: 0.08
Nodes (35): BeadsTask, buildHandoffPrompt(), captureBeadsTasks(), captureFiles(), captureGitState(), captureHandoffContext(), captureHandoffContextPromise(), execAsync (+27 more)
...
Cohesion: 0.08
Nodes (33): salvageStrandedMerge(), execFileAsync, gitFetch(), gitFetchPromise(), gitForcePush(), gitForcePushPromise(), gitMerge(), gitMergePromise() (+25 more)
...
Cohesion: 0.08
Nodes (30): NormalizedTtsDaemonConfig, getTtsDaemonAuthHeaders(), buildDirectTtsSpeakPayload(), buildTtsSpeakPayloadSync(), FetchLike, postSpeakPayload(), PromiseOrProgram, renderTemplate() (+22 more)
...
Cohesion: 0.06
Nodes (31): resetPostMergeState(), first, mockCreateResetMarker, mockExec, mockExecAsync, mockSpawn, mockSpawnChild, mockUnref (+23 more)
...
Cohesion: 0.1
Nodes (29): clearFeedbackFiles(), clearFeedbackFilesPromise(), FeedbackWriteError, getNextSequenceNumber(), resolveWorkspacePath(), writeFeedbackFilePromise(), WriteFeedbackOptions, WriteFeedbackResult (+21 more)
...
Cohesion: 0.09
Nodes (33): activeCompactions, buildContinuationSummary(), compactConversationNative(), doCompact(), estimateContextTokens(), getConversationCompactionSettings(), isCompacting(), maybeCompactBeforeRespawn() (+25 more)
...
Cohesion: 0.07
Nodes (28): backfillDiscoveredSessionArrayIndexes(), initDiscoveredSessionsSchema(), initSchema(), initWorkspaceDiscoveredSessionsSchema(), base, cols, colsAfter, colsBefore (+20 more)
...
Cohesion: 0.09
Nodes (25): confirmCost(), enrichAction(), formatCost(), findDiscoveredSessionIds(), createConfiguredClaudeApi(), enrichSession(), CostThresholdError, EnrichOptions (+17 more)
...
Cohesion: 0.1
Nodes (23): execAsync, rebaseFeatureBranchPromise(), RebaseResult, ClaudeAuthStatus, getClaudeAuthStatusImpl, parseOAuthPayload(), readKeychainCredentials, CheckpointError (+15 more)
...
Cohesion: 0.11
Nodes (25): embedAction(), findEnrichedSessionIdsMissingEmbedding(), buildEmbeddingText(), EmbedProgress, EmbedResult, embedSessions(), EmbedSessionsOptions, selectSessionIdsForEmbedding() (+17 more)
...
Cohesion: 0.15
Nodes (29): arrayPushArray(), atIndentedComment(), backfillDiscoveredSessionArrayIndexes(), blockMap(), blockScalar(), blockSequence(), document(), documentEnd() (+21 more)
...
Cohesion: 0.15
Nodes (26): BlockerReason, setReviewStatus(), addFailingSource(), getFailingChecksBlocker(), getRepoFromPrUrl(), getTrackedRepos(), handleCheckRunPromise(), handleCheckSuitePromise() (+18 more)

### Community 288 - "Community 288"
Cohesion: 0.13
Nodes (25): handleCheckRun(), handleCheckSuite(), handlePullRequest(), handlePullRequestReview(), handlePullRequestReviewThread(), handleStatus(), existingBlockers, mockGetReviewStatus (+17 more)
...
Cohesion: 0.14
Nodes (28): handleConversationImageUpload(), safeUploadExtension(), validateCwdContainment(), validateImageMagicBytes(), assertExistingPathInsideRoot(), assertWritePathInsideRoot(), isInsideRoot(), assertSafeName() (+20 more)
...
Cohesion: 0.1
Nodes (18): validateAgentDeliveryMethodOrigin(), _resetDashboardSessionTokenForTests(), issuesRouteLayer, _resetTrustedOriginsForTests(), IssueLifecycle, LinearClient, result, cachedIssue (+10 more)

### Community 336 - "Community 336"
Cohesion: 0.1
Nodes (23): writeFeedbackFile(), buildReviewFeedbackBody(), deliverReviewVerdictFeedback(), DeliverReviewVerdictFeedbackOptions, deliverReviewVerdictFeedbackPromise(), DeliverReviewVerdictFeedbackResult, execFileAsync, findLatestSynthesis() (+15 more)
...
Cohesion: 0.14
Nodes (21): setupCavemanCompressScripts(), addPanopticonHookIfMissing(), checkJqInstalled(), ClaudeSettings, HookConfig, installJq(), isHookConfigured(), McpServer (+13 more)

### Community 347 - "Community 347"
Cohesion: 0.11
Nodes (21): sentinel, emitResetMarkerCreated(), emitMemoryHealthChanged(), enqueueStatusRollupEvent(), emitMemoryObservationCreated(), emitStatusUpdatedEvent(), EventRow, EventStore (+13 more)
...
Cohesion: 0.13
Nodes (15): appendToRunLogSync(), createRunLogSync(), ensureRunsDirectory(), finalizeRunLogSync(), generateRunId(), getRecentRunLogs(), getRunLogPath(), getRunLogSync() (+7 more)
...
Cohesion: 0.19
Nodes (22): getTrackerContext(), addGitHubComment(), fetchGitHubIssue(), fetchIssueWithComments(), findLocalWorkspace(), formatComments(), getGitHubToken(), GitHubIssueResult (+14 more)
...
Cohesion: 0.17
Nodes (20): BuildReviewContextOpts, buildReviewContextPromise(), ChangedFile, execAsync, extractAcceptanceCriteria(), flattenAC(), getChangedFiles(), getCurrentBranch() (+12 more)
...
Cohesion: 0.12
Nodes (17): HARNESS_MARKERS, HarnessMarker, KNOWN_HARNESS_MARKERS, TemplateIssue, TemplateValidation, rendered, v, validateTemplate() (+9 more)
...
Cohesion: 0.12
Nodes (13): inferIssueIdFromWorkspace(), readFeatureContext(), readPendingFeedback(), WorkAgentPromptContext, bdReadyLines, template, templatePath, mockConfig (+5 more)
...
Cohesion: 0.17
Nodes (15): resolveProjectFromIssue(), asPanRpcError(), isInsidePath(), LANGUAGE_BY_EXTENSION, languageForPath(), readCappedFile(), readWorkspaceFile(), readWorkspaceFileEffect() (+7 more)
...
Cohesion: 0.2
Nodes (14): forkCommand(), ForkOptions, handoffCommand(), HandoffOptions, resolveConversation(), validateHarness(), buildCorrelationMapSync(), CorrelationResult (+6 more)
...
Cohesion: 0.13
Nodes (16): filterPayload(), combine, intIdentify(), intStringify(), number(), optimize(), stringifyNumber(), stringifySexagesimal() (+8 more)
...
Cohesion: 0.15
Nodes (14): FeedTabContent(), SessionFeedTab, filterSessionFeedEntriesForTab(), mergeSessionFeedEntries(), useMergedFeed(), UseMergedFeedResult, useObservationFeed(), duplicate (+6 more)
...
Cohesion: 0.13
Nodes (10): ReopenError, ReopenOptions, ReopenResult, reopenWorkspaceStatePromise(), activeContinuePath, continuePath, projectRoot, updated (+2 more)
...
Cohesion: 0.23
Nodes (14): pauseFlywheel(), clearFlywheelRunGate(), flywheelAbortCommand(), pauseFlywheelRun(), readFlywheelGateSnapshot(), DatabaseError, getFlywheelActiveRunId(), getSettingProgram() (+6 more)
...
Cohesion: 0.27
Nodes (3): hasTtsDaemonState(), isTtsDaemonManuallyStopped(), TtsWatchdog
...
## Knowledge Gaps
- **13928 isolated node(s):** `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR`, `__dirname`, `ROOT` (+13923 more)
...
- **Why does `string()` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 1044`, `Community 20`, `Community 21`, `Community 24`, `Community 27`, `Community 540`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 38`, `Community 39`, `Community 43`, `Community 45`, `Community 46`, `Community 51`, `Community 52`, `Community 54`, `Community 566`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 64`, `Community 65`, `Community 69`, `Community 587`, `Community 76`, `Community 78`, `Community 592`, `Community 82`, `Community 83`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 102`, `Community 104`, `Community 105`, `Community 111`, `Community 116`, `Community 636`, `Community 138`, `Community 151`, `Community 153`, `Community 666`, `Community 671`, `Community 160`, `Community 162`, `Community 165`, `Community 174`, `Community 176`, `Community 193`, `Community 713`, `Community 208`, `Community 211`, `Community 215`, `Community 244`, `Community 758`, `Community 763`, `Community 252`, `Community 255`, `Community 287`, `Community 289`, `Community 812`, `Community 305`, `Community 314`, `Community 334`, `Community 336`, `Community 344`, `Community 346`, `Community 347`, `Community 363`, `Community 890`, `Community 391`, `Community 393`, `Community 394`, `Community 395`, `Community 399`, `Community 401`, `Community 425`, `Community 426`, `Community 452`, `Community 453`, `Community 467`, `Community 473`, `Community 487`, `Community 491`, `Community 492`, `Community 494`, `Community 510`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `VBriefDocument` connect `Community 24` to `Community 33`, `Community 37`, `Community 263`, `Community 264`, `Community 105`, `Community 8`, `Community 11`, `Community 394`, `Community 16`, `Community 561`, `Community 116`, `Community 216`, `Community 88`, `Community 30`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `fetch` connect `Community 0` to `Community 1`, `Community 770`, `Community 3`, `Community 4`, `Community 5`, `Community 255`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 274`, `Community 18`, `Community 21`, `Community 24`, `Community 25`, `Community 284`, `Community 28`, `Community 669`, `Community 285`, `Community 31`, `Community 33`, `Community 164`, `Community 166`, `Community 171`, `Community 301`, `Community 303`, `Community 49`, `Community 50`, `Community 56`, `Community 57`, `Community 58`, `Community 65`, `Community 713`, `Community 73`, `Community 75`, `Community 208`, `Community 211`, `Community 469`, `Community 87`, `Community 217`, `Community 91`, `Community 347`, `Community 93`, `Community 219`, `Community 98`, `Community 103`, `Community 232`, `Community 109`, `Community 112`, `Community 635`, `Community 636`, `Community 127`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Are the 229 inferred relationships involving `string()` (e.g. with `runTmux()` and `turnForSession()`) actually correct?**
  _`string()` has 229 INFERRED edges - model-reasoned connections that need verification._
- **Are the 204 inferred relationships involving `fetch` (e.g. with `main()` and `main()`) actually correct?**
  _`fetch` has 204 INFERRED edges - model-reasoned connections that need verification._
- **What connects `__dirname`, `FIXTURES_DIR`, `TEMP_ROOT_DIR` to the rest of the system?**
  _13928 weakly-connected nodes found - possible documentation gaps or missing edges._
